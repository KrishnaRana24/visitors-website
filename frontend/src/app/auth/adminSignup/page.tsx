          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <p className="2xl:px-20">
                Unlock exclusive access and personalized experiences by joining
                our visitor community through our intuitive signup page.
              </p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link href="/auth/adminSignin" className="text-primary">
                      Sign in
                    </Link>
                  </p>
                </div>
